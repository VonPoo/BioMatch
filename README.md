...
[![Conda Version](https://img.shields.io/conda/vn/bioconda/r-deepkin?label=r-deepkin%20conda)](https://anaconda.org/bioconda/r-deepkin)
...
The CLI supports the following modes (0.4.5):
